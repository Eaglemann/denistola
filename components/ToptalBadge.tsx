...
export default function ToptalBadge({ variant = "hex" }: ToptalBadgeProps) {
  if (variant === "compact") {
    return (
      <a
        className="toptal-badge-compact"
        href="https://www.toptal.com/developers/resume/denis-tola#EMAPje"
        target="_blank"
  ...
  return (
    <section className="toptal-badge-wrapper" aria-label="Toptal recognition badge">
      <div className="toptal-badge-shell">
        <div className="toptal-badge-card">
          <svg
            className="toptal-badge-stars"
            viewBox="0 0 60 17"
            aria-hidden="true"
          ...
          <h3 className="toptal-badge-title">TOP 3% TALENT</h3>
          <div className="toptal-badge-divider" />

          <p className="toptal-badge-vetted">Vetted by</p>
          <svg
            className="toptal-badge-wordmark"
            viewBox="0 0 108 30"
            role="img"
            aria-label="Toptal"
            xmlns="http://www.w3.org/2000/svg"
